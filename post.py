...
class Post:
    ...
    # @exceptions.common_exceptions_decorator
    # def bulk_payments(self, payments):
    #     """
    #     Create multiple payments in ECM3, in the form of uploading an
    #     array of payment objects
    #
    #     :Required args:
    #     - payments[]
    #     -- contract - The GUID of the contract the new payment will be
    #         made against.
    #     -- collection_amount - The collection amount of the new payment.
    #     -- collection_date - The collection date of the new payment.
    #     -- a_comment - A comment related to the new payment.
    #     -- is_credit - If you have your own SUN and you have made prior
    #         arrangements with Eazy Collect, this may be passed to issue
    #         a credit to a customer. By default, it is set to false.
    #
    ...
    #         payment['amount'] = payment['collection_amount']
    #         payment['date'] = payment['collection_date']
    #         payment['comment'] = payment['a_comment']
    #         payment['isCredit'] = payment['is_credit']
    #         del payment['collection_amount']
    #         del payment['collection_date']
    #         del payment['a_comment']
    #         del payment['is_credit']
    #
    #         #payment_checks.check_collection_date(payment['date'])
    #         # if payment['isCredit']:
    #         #     e = payment_checks.is_credit_allowed_check()
    #         #     if not e:
    #         #         payment['isCredit'] = False
    #
    #     self.api.endpoint = 'bulk/payments'
    #     self.api.params = {'Payments': payments}
