        ...
        if day_difference >= 365 or other['force_schedule_updates']:
            ...
            for i in range(len(schedule_list)):
                ...
                for schedule in schedules:
                    # Ad-hoc will appear nowhere else other than potentially
                    # name. It will be in Description every time, however.
                    ...
                    # We save the date in ISO format, but JSON cannot parse a
                    # date
